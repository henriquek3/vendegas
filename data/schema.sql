...
DROP TABLE IF EXISTS `vendegasapp`.`clients`;
CREATE TABLE IF NOT EXISTS `vendegasapp`.`clients` (
...
INSERT INTO `vendegasapp`.`clients`(name,email,cpf,phone,birthday,marital_status)
